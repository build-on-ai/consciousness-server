...
- `search-memory-example` — find related notes, design decisions, past ADRs.
- `summarize-session-example` — compress a long working session into a doc
  seed.
